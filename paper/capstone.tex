...
At the time of writing, the only commercially available HSM that offered the right features features for the project was the "Nitrokey Start" from Nitrokey in Germany\cite{noauthor_nitrokey_2022}.\begin{wrapfigure}{r}{0.5\textwidth}
\itemsep0em 
\frame{\includegraphics[width=6cm]{paper/images/nitrokey.jpg}}
\caption{Image of the Nitrokey Start Hardware Security Module}
\label{img:nitrokey}
\end{wrapfigure} A few HSM list support for 'Curve25519' yet most only support Ed25519 while WireGuard only uses the X25519 algorithm of Curve25519.
...
\multicolumn{2}{ l }{\textbf{Damage} - If the vulnerability is exploited, how much damage does it cause to the system?}\\
