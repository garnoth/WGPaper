...
// encrypt static key
	...
	Using the local Ephemeral private key and the peer's static public key, derive a shared key.
	Create a 256-bit encryption key for chacha20poly1350.
    This key is created by the KDF2 algorithm with the derived key ss as input and the initial chainkey value value (a predetermined, static value but irrelevant for our discussion)
